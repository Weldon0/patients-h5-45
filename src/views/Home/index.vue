  ...
  <div class="home-page">
    <div class="home-header">
      <div class="con">
        <h1>优医</h1>
        <div class="search">
          <cp-svg-icon name="home-search" /> 搜一搜：疾病/症状/医生/健康知识
        </div>
      </div>
    </div>
    <div class="home-navs">
      <van-row>
        <van-col span="8">
          <router-link to="/" class="nav">
            <cp-svg-icon name="home-doctor"></cp-svg-icon>
            <p class="title">问医生</p>
        ...
        <van-col span="8">
          <router-link
            ...
            class="nav"
          >
            <cp-svg-icon name="home-graphic"></cp-svg-icon>
        ...
        <van-col span="8">
          <router-link to="/" class="nav">
            <cp-svg-icon name="home-prescribe"></cp-svg-icon>
      ...
      <van-row>
        <van-col span="6">
          <router-link to="/" class="nav min">
            <cp-svg-icon name="home-order"></cp-svg-icon>
            <p class="title">药品订单</p>
          </router-link>
        </van-col>
        <van-col span="6">
          <router-link to="/" class="nav min">
            <cp-svg-icon name="home-docs"></cp-svg-icon>
            <p class="title">健康档案</p>
          </router-link>
        </van-col>
        <van-col span="6">
          <router-link to="/" class="nav min">
            <cp-svg-icon name="home-rp"></cp-svg-icon>
            <p class="title">我的处方</p>
          </router-link>
        </van-col>
        <van-col span="6">
          <router-link to="/" class="nav min">
            <cp-svg-icon name="home-find"></cp-svg-icon>
