  ...
  <div class="user-page">
    ...
    <div class="user-page-group">
      ...
      <van-cell
        ...
        :to="item.path"
      >
        <template #icon><cp-svg-icon :name="`user-tool-0${i + 1}`" /></template>
      </van-cell>
